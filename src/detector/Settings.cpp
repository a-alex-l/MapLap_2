...
int Settings::count_of_attempts_find_line   = 100000;
int Settings::count_of_attempts_find_ellipses = 20;
int Settings::block_size = 101;
int Settings::black_level = 20;
std::vector<double> Settings::check_ellipses = {0.4, 0.5, 0.6, -0.4, -0,5, -0.6};
